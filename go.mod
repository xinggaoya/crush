...
require (
	...
	github.com/charmbracelet/bubbletea/v2 v2.0.0-beta.4.0.20250813201422-d4d69f63338d
...
require (
	...
	github.com/charmbracelet/ultraviolet v0.0.0-20250811142928-f69b0392d22a
